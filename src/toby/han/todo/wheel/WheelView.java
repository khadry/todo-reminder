...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_center_item_cover);
		}
...
//        drawShadows(canvas);
	...
	private void drawItems(Canvas canvas) {
		...
		for(int i=0; i < count; ++i) {
		    View curView = itemsLayout.getChildAt(i);
	        if(curView instanceof TextView) {
	            TextView tv = (TextView)curView;
	            if(i == count/2) {
	                tv.setTextColor(0xFF0000F0);
	            }
	            else {
